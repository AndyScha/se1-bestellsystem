...
/**
* InventoryManager is a component of the order processing system that manages the
* inventory of articles that is available for sale.
*
* An order can be filled only when sufficient inventory (current number of available
* units for each article) is available for all items on an order.
*
...
*     ]
*   }
* cannot be filled since inventory of the second item: "SKU‐693856" is only 4 units.
*/
