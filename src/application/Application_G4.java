...
public class Application_G4 {
	...
	public static void main(String[] args) {
		var appInstance = new Application_G4();
		appInstance.run();
	}
	...
	private void run() {
		...
		orderBuilder
			...
			.buildMoreOrders();
		//
		Customer eric = datamodelFactory.findCustomerById(892474).get();
		Article book_Java = datamodelFactory.findArticleById("SKU-278530").get();
		Article book_OOP = datamodelFactory.findArticleById("SKU-425378").get();
		//
		Order o2453 = datamodelFactory.createOrder(eric)
			.setId("2453034882")
			.addItem(book_Java, 4)
			.addItem(book_OOP, 4);
		//
		orderBuilder
			.accept(o2453);		// <-- new method accept()
