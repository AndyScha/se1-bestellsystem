...
//			.addItem(book_OOP, 1)
		;
		//
for (Order o :datamodelFactory.getOrders()) 

		try {
			//
			if(inventoryManager.isFillable(o)) {
				//
				inventoryManager.fill(o);
			}
		//
		} catch(AssertionError ae) {
			var err = String.format("Order: %s is not fillable from current inventory", o8592.getId());
